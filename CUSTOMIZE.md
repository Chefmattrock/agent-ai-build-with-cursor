...
### Agent to help do this: [ICP Builder](https://agent.ai/agent/icp-builder)
...
1. **Persona examples** — For each persona, add a sample Premium agent with a one-line RAVE justification for each criterion.
2. **#GoodToGo question** — Replace the placeholder with a description of your target user.
...
### Agent to help do this: [Brand Guideline Builder](https://agent.ai/agent/brand-guideline-builder)
...
## Step 4 — Fill In the Writing Style Guide
...
### Agent to help with this: [Writing Style Finder](https://agent.ai/agent/Writing-Style-Finder)
...
## Step 5 — Customize the PMB Generator Prompt
...
## Step 6 — Update the Discovery Call Script (Quick)
...
Run through this checklist once you've completed all 6 steps:
