...
You will receive two inputs to generate the PRD:
...
**Input 2: Agent JSON Configuration**
```
{{json_explanation}}
```
...
Use these inputs to populate all sections of the PRD, ensuring technical details from the JSON are reflected in:
- Section 4 (Technical Considerations)
- Section 6 (Agent Configuration)
- Section 7 (URS Validation)
